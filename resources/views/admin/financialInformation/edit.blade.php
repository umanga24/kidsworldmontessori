...
@section('title','Edit Financial Information')
@push('admin.styles')
<!-- Date Picker -->
...
<section class="content-header">
	<h1>Financial Information<small>edit</small></h1>
	<ol class="breadcrumb">
...
<div class="content">
	...
	@endif
<form method="post" action="{{route('financial-information.update',$detail->id)}}" enctype="multipart/form-data">
	{{csrf_field()}}
