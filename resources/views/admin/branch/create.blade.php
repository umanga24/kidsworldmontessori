...
<section class="content-header">
	<h1>ShareHolder<small>Add</small></h1>
	<ol class="breadcrumb">
			...
			<div class="col-md-8">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<!--<div class="form-group">
							<label>Timing</label>
							<input type="text" name="timing" class="form-control" value="{{old('timing')}}">
						</div> -->
						<div class="form-group">
							<label>Full Address</label>
							<textarea class="form-control" name="address" rows="6">{{old('full_address')}}</textarea>
						</div>
						<!--	<div class="form-group">
							<label>Map</label>
							<textarea class="form-control" name="map" rows="6">{{old('map')}}</textarea>
						</div> -->
						<div class="box-body">
							<!--<div class="form-group">
