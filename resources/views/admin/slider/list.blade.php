...
>
				           ...
				           <td>
				            	<a class="btn btn-info edit " href="{{route('slider.edit',$detail->id)}}" title="Edit">Edit</a>
                        		<form method= "post" action="{{route('slider.destroy',$detail->id)}}" class="delete btn btn-danger">
                        		{{csrf_field()}}
